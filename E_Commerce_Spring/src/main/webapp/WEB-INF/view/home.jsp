...
<div class="main">
    <div class="header">
        <ul>
            ...
            <li class="dropdown"><a href="#"><button class="btn">Login</button></a>
                <div class="dropdown-content">
                    <a href="sign_up_page">New Customer? <span style="display:inline-block">SignUp</span></a>
    ...
    <div class="products_items" style="background-image: url('mens.jpg');">
        <a href="productlistpage.jsp"><button class="products_items_btn" disabled>Men Products</button></a>
    </div>
    <div class="products_items">
        <a href="#"><button class="products_items_btn" disabled>Women Products</button></a>
    </div>
    <div class="products_items">
        <a href="#"><button class="products_items_btn" disabled>Kids Products</button></a>
    </div>
</div>
</body>
</html>